...
class PoseClassifier(object):
  ...
  def __init__(self):
    # load models
    self.clf_clas = load(r'fitness_trainer-main\resources\models\cascade\xgb_clf.model')
    self.clf_subclas = load(r'fitness_trainer-main\resources\models\cascade\knn_clf.model')
    self.clas_encoder = load(r'fitness_trainer-main\resources\models\cascade\clas_encoder.model')
    self.subclas_encoder = load(r'fitness_trainer-main\resources\models\cascade\subclas_encoder.model')
